...
const NAV: NavItem[] = [
  ...
  { label: 'Campagne', path: '/campaign', roles: ['war_room', 'regional_coordinator', 'zone_leader', 'field_agent', 'logistics_team'] },
  { label: 'Événements', path: '/events', roles: ['war_room', 'regional_coordinator', 'zone_leader', 'field_agent', 'direction', 'digital_team'] },
  { label: 'Adhésions', path: '/members', roles: ['war_room', 'regional_coordinator', 'zone_leader', 'membership_data_entry'] },
  { label: 'Médias', path: '/media', roles: ['war_room', 'regional_coordinator', 'zone_leader', 'direction', 'digital_team'] },
  { label: 'Sondages', path: '/polling', roles: ['war_room', 'regional_coordinator'] },
  { label: 'Logistique', path: '/logistique', roles: ['war_room', 'regional_coordinator', 'direction', 'logistics_team'] },
  { label: 'Réseaux sociaux', path: '/social', roles: ['war_room', 'regional_coordinator', 'direction', 'digital_team'] },
